...
<body class="bg-light">
  ...
  /*  
    ...
    user is looged in or not 
    also if the shutdown mode has been activated or not
  */
  ...
  <script>
    ...
    function check_availability() {
      ...
      if (checkin_val != '' && checkout_val != '') 
      {
        ...
        xhr.open("POST", "nas/confirm_booking.php",true);

        xhr.onload = function () {
          let data =JSON.parse(this.responseText);

          if(data.status == 'check_in_out_equal'){
            pay_info.innerText = "You connot check-out on the same day!";
          }
            ...
            pay_info.innerText = "Room not available for this chick-in date!";
          }
          else {
            pay_info.innerHTML = "No. of days: "+data.days+"<br>Total Amount to Pay: "+data.payment+"DH";
