    ...
    if($total_rows>$limit)
    {
        ...
        if($page!=1){
            $pagination .= "<li class='page-item'>
                <button onclick='change_page(1)' class='page-link shadow-none'>First page</button>
            </li>";
        }
        ...
        $disabled = ($page==$total_rows) ? "disabled" : "";
        $next = $page+1;
        $pagination .= "<li class='page-item $disabled'>
        ...
        if($page!=$total_pages){
            $pagination .= "<li class='page-item'>
                <button onclick='change_page($total_pages)' class='page-link shadow-none'>Last page</button>
            </li>";
        }
    }
