...
<body class="bg-light">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    while ($opt = mysqli_fetch_array($res)) {
                                        echo "
    ...
    <script>
        ...
        function add_room() {
            ...
            xhr.open("POST", "nas/rooms.php", true);
            ...
            xhr.onload = function () {
                ...
                if (this.responseText == 1) {
                    alert('success', ' New Room Has been Added successfully');
                    add_room_form.reset();
                    get_all_rooms();
                }
                else {
        ...
        function add_image() {
            ...
            xhr.onload = function () {
                ...
                if (this.responseText == 'inv_img') {
                    ...
                    alert('error', 'image is too large it surpass 3 mb', 'image-alert');
                }
                else if (this.responseText == 'upd_failed') {
                    alert('error', 'image upload failed.Server Down!', 'image-alert');
                }
                else {
                    alert('success', 'The New Image Added successfully', 'image-alert');
