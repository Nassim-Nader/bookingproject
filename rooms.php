...
<body class="bg-light">
              ...
              <div class="border bg-light p-3 rounded mb-3">
                ...
                <?php
                  ...
                  while($row = mysqli_fetch_assoc($facilities_q))
                  {
                    echo <<<facilities
                      <div class="mb-2">
                        <input type="checkbox" onclick="fetch_rooms()" name="facilities" value="$row[id]" class="form-check-input shadow-none me-3" id="$row[id]">
  ...
  <script>
    ...
    function fetch_rooms()
    {
      ...
      xhr.open("GET", "nas/rooms.php?fetch_rooms&chk_avail="+chk_avail+"&guests="+guests+"&facility_list="+facility_list, true);
